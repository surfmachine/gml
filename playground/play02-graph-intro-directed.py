...
print("#")
print("# Create directed graph with networkx")
print("#")
...
edges = [('Milan','Dublin'), ('Paris','Milan'), ('Paris','Dublin'), ('Milan','Rome')]
...
draw_graph(graph, pos_nodes=nx.shell_layout(graph), node_size=500)


print("#")
print("# Create directed graph with graph classes")
print("#")
